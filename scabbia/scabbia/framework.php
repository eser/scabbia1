<?php
	...
	class framework {
		...
		public static function load() {
			...
			require(framework::$vendorpath . 'scabbia/scabbia/patches.php');
			// require(framework::$vendorpath . 'scabbia/scabbia/framework.php');
			require(framework::$vendorpath . 'scabbia/scabbia/config.php');
			require(framework::$vendorpath . 'scabbia/scabbia/events.php');
			require(framework::$vendorpath . 'scabbia/scabbia/extensions.php');
