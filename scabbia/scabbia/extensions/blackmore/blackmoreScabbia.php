<?php
	...
	class blackmoreScabbia {
		...
		public static function index() {
			...
			views::viewFile('{vendor}scabbia/scabbia/views/blackmore/scabbia/index.php');
		}
		...
		public static function debug() {
			...
			views::viewFile('{vendor}scabbia/scabbia/views/blackmore/scabbia/debug.php');
		}
...
?' . '>');
			*/
			...
			$tCompiled .= framework::printFile(file_get_contents(framework::$vendorpath . 'scabbia/scabbia/patches.php'));
			$tCompiled .= framework::printFile(file_get_contents(framework::$vendorpath . 'scabbia/scabbia/framework.php'));
			$tCompiled .= framework::printFile(file_get_contents(framework::$vendorpath . 'scabbia/scabbia/config.php'));
			$tCompiled .= framework::printFile(file_get_contents(framework::$vendorpath . 'scabbia/scabbia/events.php'));
			$tCompiled .= framework::printFile(file_get_contents(framework::$vendorpath . 'scabbia/scabbia/extensions.php'));
