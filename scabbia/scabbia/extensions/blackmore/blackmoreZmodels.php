<?php
	...
	class blackmoreZmodels {
		...
		public static function generateSql() {
			...
			views::viewFile('{vendor}scabbia/scabbia/views/blackmore/zmodels/sql.php', array(
			                                                              'sql' => $tSql
			                                                         ));
		}
		...
		public static function all() {
			...
			views::viewFile('{vendor}scabbia/scabbia/views/blackmore/zmodels/list.php', array(
			                                                               'module' => $tModule,
			                                                               'rows' => $tRows
			                                                          ));
		}
		...
		public static function add($uAction) {
			...
			views::viewFile('{vendor}scabbia/scabbia/views/blackmore/zmodels/form.php', $tViewbag);
		}
