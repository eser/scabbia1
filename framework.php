...
// Include framework dependencies and load them
	...
	require(QPATH_CORE . 'library/framework.php');
	require(QPATH_CORE . 'library/config.php');
	require(QPATH_CORE . 'library/events.php');
	require(QPATH_CORE . 'library/extensions.php');
